...
var MapaRotaPage = /** @class */ (function () {
    ...
    MapaRotaPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-mapa-rota',template:/*ion-inline-start:"C:\Users\enail\Documentos\PF2\SUSSemFilaOriginal\src\pages\mapa-rota\mapa-rota.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>Rota até a melhor unidade</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n<div class="form-error">{{mapaError}}</div>\n<div>\n  <h3>Tempo Total para ser atendido: {{tempoTotal}}</h3>\n  <h4>Unidade SUS: {{bestUnidade}}</h4>\n</div>\n<div #map id="map" style="height:100%;"></div>\n</ion-content>\n'/*ion-inline-end:"C:\Users\enail\Documentos\PF2\SUSSemFilaOriginal\src\pages\mapa-rota\mapa-rota.html"*/,
        }),
...
var MapaPage = /** @class */ (function () {
    ...
    MapaPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-mapa',template:/*ion-inline-start:"C:\Users\enail\Documentos\PF2\SUSSemFilaOriginal\src\pages\mapa\mapa.html"*/'<ion-content padding>\n\n\n<ion-fab left bottom>\n  <button ion-fab mini (click)="inserirTempoAtendimento()"><ion-icon name="add"></ion-icon></button>\n</ion-fab>\n<ion-fab right bottom>\n  <button ion-fab (click)="inserirFiltros()"><ion-icon name="search"></ion-icon></button>\n</ion-fab>\n<div #map id="map_canvas" style="height:100%;">\n\n</div>\n</ion-content>\n'/*ion-inline-end:"C:\Users\enail\Documentos\PF2\SUSSemFilaOriginal\src\pages\mapa\mapa.html"*/,
        }),
